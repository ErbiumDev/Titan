...
public:
	...
	uint8                                        Pad_2C0C[0x50];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_2C0D[0x5];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_2C0E[0x28];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
