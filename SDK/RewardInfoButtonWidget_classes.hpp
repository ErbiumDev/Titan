...
public:
	...
	class UHorizontalBox*                        ItemDetails;                                       // 0xB50(0x8)(BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	class UCommonTextBlock*                      ItemInfo;                                          // 0xB58(0x8)(BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	class FText                                  DisplayNameText;                                   // 0xB60(0x18)(Edit, BlueprintVisible, DisableEditOnInstance)
	class FText                                  DisplayQuantity;                                   // 0xB78(0x18)(Edit, BlueprintVisible, DisableEditOnInstance)
