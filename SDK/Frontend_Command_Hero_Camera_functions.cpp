...
{
	static auto Func = Class->GetFunction("Frontend_Command_Hero_Camera_C", "UserConstructionScript");

	Params::AFrontend_Command_Hero_Camera_C_UserConstructionScript_Params Parms;
