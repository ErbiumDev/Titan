...
{
public:
	uint8                                        Pad_11AF[0x1B8];                                   // Fixing Size After Last Property  [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_11B0[0x60];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_11B3[0x2E];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_11B5[0x17];                                    // Fixing Size After Last Property  [ Dumper-7 ]
