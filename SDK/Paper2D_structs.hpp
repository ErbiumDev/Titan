...
public:
	...
	uint8                                        Pad_28F7[0x4];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_2907[0x40];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
